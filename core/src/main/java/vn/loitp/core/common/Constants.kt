...
object Constants {
    ...
    val ARR_RANDOM_BKG = intArrayOf(R.drawable.bkg_gradient_man_of_steel, R.drawable.bkg_shadow_black_white, R.drawable.bkg_shadow_black_white_dark, R.drawable.bkg_shadow_white_black, R.drawable.bkg_shadow_white_black_dark)
    ...
    val ARR_RANDOM_MINI_DRAWABLE = intArrayOf(R.drawable.circle, R.drawable.circle_effect, R.drawable.download, R.drawable.gesture, R.drawable.iv, R.drawable.l_bin, R.drawable.l_book_5, R.drawable.l_calculator, R.drawable.l_calculator_2, R.drawable.l_calendar, R.drawable.l_calendar_5, R.drawable.l_call, R.drawable.l_car, R.drawable.l_certificate, R.drawable.l_chart, R.drawable.l_chart_2, R.drawable.l_chart_3, R.drawable.l_chart_5, R.drawable.l_chat, R.drawable.l_check, R.drawable.l_clear, R.drawable.l_clock, R.drawable.l_close, R.drawable.l_coin, R.drawable.l_compass, R.drawable.l_credit_card, R.drawable.l_diamon, R.drawable.l_drag, R.drawable.l_error_404, R.drawable.l_file, R.drawable.l_file_3, R.drawable.l_film, R.drawable.l_gallery, R.drawable.l_game, R.drawable.l_gift, R.drawable.l_global, R.drawable.l_heart, R.drawable.l_help, R.drawable.l_help_1, R.drawable.l_help_2, R.drawable.l_help_3, R.drawable.l_help_4, R.drawable.l_help_5, R.drawable.l_help_6, R.drawable.l_help_7, R.drawable.l_hint_3, R.drawable.l_info, R.drawable.l_info_2, R.drawable.l_location, R.drawable.l_lock, R.drawable.l_mail, R.drawable.l_map, R.drawable.l_medal, R.drawable.l_medal_2, R.drawable.l_medal_3, R.drawable.l_money, R.drawable.l_money_4, R.drawable.logo, R.drawable.spinner, R.drawable.l_note, R.drawable.l_note_2, R.drawable.l_note_3, R.drawable.l_note_5, R.drawable.l_save, R.drawable.ladybird, R.drawable.l_chat_2)
