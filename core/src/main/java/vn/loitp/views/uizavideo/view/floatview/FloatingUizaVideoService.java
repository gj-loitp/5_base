...
public class FloatingUizaVideoService extends Service implements VideoRendererEventListener {
    ...
    private void openApp() {
        /*Intent intent = new Intent(FloatingUizaVideoService.this, FloatingWidgetVideoActivity.class);
