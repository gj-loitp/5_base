        ...
        set(value) {
            ...
            if (animated) {
                ...
                animation?.addUpdateListener { valueAnimator ->
                    ...
                    mOnRangeSeekBarViewChangeListener?.onProgressChanged(
                        this@RangeSeekBarView,
                        valueToDraw.toInt(),
                        true
                    )
                    this.invalidate()
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (eventAction) {
            MotionEvent.ACTION_DOWN -> {
                //isUserTouched = true
                mOnRangeSeekBarViewChangeListener?.onStartTrackingTouch(
                    this@RangeSeekBarView,
                    currentValue
                )
            ...
            MotionEvent.ACTION_UP -> {
                ...
                mOnRangeSeekBarViewChangeListener?.onStopTrackingTouch(
                    this@RangeSeekBarView,
                    currentValue
                )
