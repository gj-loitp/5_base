...
import com.loitp.views.tagsphere.TagSphereViewDelegate.Companion.DEFAULT_RADIUS
import com.loitp.views.tagsphere.TagSphereViewDelegate.Companion.DEFAULT_SENSITIVITY
        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                viewDelegate.sensitivity =
                    getInteger(R.styleable.TagSphereView_tsv_touchSensitivity, DEFAULT_SENSITIVITY)
                viewDelegate.rotateOnTouch =
                    getBoolean(R.styleable.TagSphereView_tsv_rotateOnTouch, true)
                viewDelegate.radius = getFloat(R.styleable.TagSphereView_tsv_radius, DEFAULT_RADIUS)
                getInt(R.styleable.TagSphereView_tsv_easingFunction, -1).let {
