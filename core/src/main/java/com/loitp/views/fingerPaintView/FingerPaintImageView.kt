        ...
        if (attrs != null) {
            ...
            try {
                strokeColor = typedArray.getColor(
                    R.styleable.FingerPaintImageView_strokeColorFPIV,
                    defaultStrokeColor
                )
                strokeWidth = typedArray.getDimension(
                    R.styleable.FingerPaintImageView_strokeWidthFPIV,
                    defaultStrokeWidth
                )
                inEditMode =
                    typedArray.getBoolean(R.styleable.FingerPaintImageView_inEditModeFPIV, false)
                touchTolerance = typedArray.getFloat(
                    R.styleable.FingerPaintImageView_touchToleranceFPIV,
