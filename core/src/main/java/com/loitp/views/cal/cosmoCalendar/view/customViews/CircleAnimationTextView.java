package com.loitp.views.cal.cosmoCalendar.view.customViews;
...
public class CircleAnimationTextView extends AppCompatTextView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (View.MeasureSpec.getMode(widthMeasureSpec) == View.MeasureSpec.EXACTLY) {
            ...
            super.onMeasure(widthMeasureSpec, CalendarUtils.getCircleWidth(getContext()) + View.MeasureSpec.EXACTLY);
        } else {
