...
import static com.function.pump.download.ErrorCode.ERROR_FILE_OUT_LIMIT;
...
import com.function.pump.download.utils.FileUtil;
...
public class DownloadBlockTask extends Task {
    ...
    private void calculateCompletedSize() {
        ...
        if (tempDir != null) {
            tempFile = new File(tempDir, Util.DOWNLOAD_PART + blockId);
        }
    }
