    ...
    class Config {
        ...
        companion object {
            ...
            fun fromTypeArray(typedArray: TypedArray): Config {
                ...
                config.initX = typedArray.getDimension(R.styleable.LHeartLayout_initX,
                        res.getDimensionPixelOffset(R.dimen.heart_anim_init_x).toFloat()).toInt()
                config.initY = typedArray.getDimension(R.styleable.LHeartLayout_initY,
                        res.getDimensionPixelOffset(R.dimen.heart_anim_init_y).toFloat()).toInt()
                config.xRand = typedArray.getDimension(R.styleable.LHeartLayout_xRand,
                        res.getDimensionPixelOffset(R.dimen.heart_anim_bezier_x_rand).toFloat()).toInt()
                config.animLength = typedArray.getDimension(R.styleable.LHeartLayout_animLength,
                        res.getDimensionPixelOffset(R.dimen.heart_anim_length).toFloat()).toInt()
                config.animLengthRand = typedArray.getDimension(R.styleable.LHeartLayout_animLengthRand,
                ...
                config.xPointFactor = typedArray.getDimension(R.styleable.LHeartLayout_xPointFactor,
                        res.getDimensionPixelOffset(R.dimen.heart_anim_x_point_factor).toFloat()).toInt()
                config.heartWidth = typedArray.getDimension(R.styleable.LHeartLayout_heart_width,
                        res.getDimensionPixelOffset(R.dimen.heart_size_width).toFloat()).toInt()
                config.heartHeight = typedArray.getDimension(R.styleable.LHeartLayout_heart_height,
