...
public class SuggestPopupView extends RelativePopupWindow {

    public SuggestPopupView(Context context) {
        View layout = LayoutInflater.from(context).inflate(R.layout.view_auto_suggest_edittext_popup, null);
