...
public class LAnswerView extends LinearLayout implements View.OnClickListener {
    ...
    public interface OnAnswerChange {
        void onAnswerChange(LAnswerView view, int index);
    }
    ...
    public LAnswerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LAnswerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public LAnswerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LAnswerView, 0, 0);

            aw_ShowTextWhenActive = a.getBoolean(R.styleable.LAnswerView_aw_ShowTextWhenActive, false);
            aw_changeOnClick = a.getBoolean(R.styleable.LAnswerView_aw_changeOnClick, true);
            aw_canCancelAnswer = a.getBoolean(R.styleable.LAnswerView_aw_canCancelAnswer, true);

            int count = a.getInt(R.styleable.LAnswerView_aw_NumberOfAnswers, 5);
