...
import com.loitp.views.calendar.cosmoCalendar.listeners.OnMonthChangeListener;
...
import com.loitp.views.calendar.cosmoCalendar.selection.NoneSelectionManager;
import com.loitp.views.calendar.cosmoCalendar.selection.OnDaySelectedListener;
import com.loitp.views.calendar.cosmoCalendar.selection.RangeSelectionManager;
import com.loitp.views.calendar.cosmoCalendar.selection.SingleSelectionManager;
import com.loitp.views.calendar.cosmoCalendar.selection.selectionBar.MultipleSelectionBarAdapter;
...
import com.loitpcore.views.calendar.cosmoCalendar.utils.WeekDay;
import com.loitpcore.views.calendar.cosmoCalendar.utils.snap.GravitySnapHelper;
import com.loitpcore.views.calendar.cosmoCalendar.view.customViews.CircleAnimationTextView;
import com.loitpcore.views.calendar.cosmoCalendar.view.customViews.SquareTextView;
...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
    ...
    private void handleAttributes(TypedArray typedArray) {
        int orientation = typedArray.getInteger(R.styleable.CalendarView_cvOrientation, SettingsManager.DEFAULT_ORIENTATION);
