...
interface FlickrService {
    @GET("rest/")
    fun getListPhotoset(@Query("method") method: String?,
                        ...
                        @Query("nojsoncallback") noJsonCallback: Int): Observable<WrapperPhotosetGetlist?>

    @GET("rest/")
    fun getPhotosetPhotos(@Query("method") method: String?,
                          @Query("api_key") apiKey: String?,
                          ...
                          @Query("page") page: Int,
                          @Query("format") format: String?,
                          @Query("nojsoncallback") noJsonCallback: Int): Observable<WrapperPhotosetGetPhotos?>
}
