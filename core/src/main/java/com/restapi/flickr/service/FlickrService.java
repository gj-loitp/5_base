...
public interface FlickrService {
    @GET("rest/")
    Observable<WrapperPhotosetGetlist> getListPhotoset(@Query("method") String method,
    ...
    @GET("rest/")
    Observable<WrapperPhotosetGetPhotos> getPhotosetPhotos(@Query("method") String method,
                                                           @Query("api_key") String apiKey,
