        ...
        when (v?.id) {
            R.id.btnImagePicker -> {
                val intent = Lassi(this)
                    ...
                    .setAlertDialogNegativeButtonColor(com.loitp.R.color.red)
                    .setAlertDialogPositiveButtonColor(com.loitp.R.color.green)
                    .setProgressBarColor(R.color.colorAccent)
                    .setGalleryBackgroundColor(com.loitp.R.color.gray)
            ...
            R.id.btnDocumentSystemIntent -> {
                val intent = Lassi(this)
                    ...
                    .setMaxCount(3)
                    .setCustomLimitExceedingErrorMessage(com.lassi.R.string.error_exceed_msg)
                    .build()
                receiveData.launch(intent)
            }
