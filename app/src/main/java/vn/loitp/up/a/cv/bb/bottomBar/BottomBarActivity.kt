...
//    }
    ...
    private fun setupViews() {
        ...
        with(binding.bottomBar) {
            paddingOnInDp = context.resources.getDimension(com.loitp.R.dimen.w_10).toInt()
            paddingOffInDp = context.resources.getDimension(com.loitp.R.dimen.margin_padding_medium).toInt()
            colorIvOn = com.loitp.R.color.red
            colorIvOff = com.loitp.R.color.pink
            setTextMarginBottom(context.resources.getDimension(com.loitp.R.dimen.w_5).toInt())
            setItem0(com.loitp.R.drawable.ic_bug_report_black_48dp, "Bug report")
            setItem1(com.loitp.R.drawable.ic_add_black_48dp, "Add")
            setItem2(com.loitp.R.drawable.ic_chat_black_48dp, "Chat")
            setItem3(com.loitp.R.drawable.ic_close_black_48dp, "Clear")
            setItem4(com.loitp.R.drawable.ic_cloud_download_black_48dp, "Cloud")
            setItem5(com.loitp.R.drawable.ic_picture_in_picture_alt_black_48dp, "Picture")
        ...
        binding.btBlurViewRed.setOnClickListener {
            binding.bottomBar.getRealTimeBlurView().setOverlayColor(getColor(com.loitp.R.color.red50))
        }
        binding.btBlurViewGreen.setOnClickListener {
            binding.bottomBar.getRealTimeBlurView().setOverlayColor(getColor(com.loitp.R.color.green33))
        }
