...
import vn.loitp.databinding.ARecyclerTabLayoutDemoTabOnScreenLimitBinding
...
class RvTabOnScreenLimitActivity : BaseActivityFont() {
    private lateinit var binding: ARecyclerTabLayoutDemoTabOnScreenLimitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ARecyclerTabLayoutDemoTabOnScreenLimitBinding.inflate(layoutInflater)
