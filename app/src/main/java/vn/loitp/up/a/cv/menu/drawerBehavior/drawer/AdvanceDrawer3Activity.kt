...
import vn.loitp.R
import vn.loitp.databinding.ADrawerBehaviorAdvance3Binding

@LogTag("AdvanceDrawer3Activity")
@IsFullScreen(false)
class AdvanceDrawer3Activity : BaseActivityFont(), NavigationView.OnNavigationItemSelectedListener {

    private lateinit var binding: ADrawerBehaviorAdvance3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ADrawerBehaviorAdvance3Binding.inflate(layoutInflater)
