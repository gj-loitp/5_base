...
class MenuLayoutActivity : BaseActivityFont(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v) {
            ...
            binding.btSwipebackLayout -> launchActivity(SwipeBackLayoutActivityFont::class.java)
            ...
            binding.btSquareLayout -> launchActivity(SquareLayoutActivityFont::class.java)
            ...
            binding.btSwipeRevealLayout -> launchActivity(SwipeRevealLayoutActivityFont::class.java)
