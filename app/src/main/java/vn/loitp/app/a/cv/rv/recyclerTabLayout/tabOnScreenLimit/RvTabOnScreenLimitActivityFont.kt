package vn.loitp.app.a.cv.rv.recyclerTabLayout.tabOnScreenLimit
...
@IsFullScreen(false)
class RvTabOnScreenLimitActivityFont : BaseActivityFont() {
    ...
    companion object {
        ...
        fun startActivity(context: Context, demo: Demo) {
            val intent = Intent(context, RvTabOnScreenLimitActivityFont::class.java)
