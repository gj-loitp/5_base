package vn.loitp.app.a.customviews.layout
...
import vn.loitp.R
import vn.loitp.app.a.customviews.layout.androidSlidingUpPanel.AndroidSlidingUpPanelActivity
import vn.loitp.app.a.customviews.layout.aspectratio.AspectRatioLayoutActivity
import vn.loitp.app.a.customviews.layout.autoLinearLayout.AutoLinearLayoutActivity
import vn.loitp.app.a.customviews.layout.autoScrollContent.AutoScrollContentActivity
import vn.loitp.app.a.customviews.layout.basketLayout.BasketLayoutActivity
import vn.loitp.app.a.customviews.layout.chess.ChessLayoutActivity
import vn.loitp.app.a.customviews.layout.circularView.CircularViewActivity
import vn.loitp.app.a.customviews.layout.constraintLayout.MenuConstraintlayoutActivity
import vn.loitp.app.a.customviews.layout.coordinatorLayout.MenuCoordinatorLayoutActivity
import vn.loitp.app.a.customviews.layout.cornerCutLinearLayout.CornerCutLinearLayoutActivity
import vn.loitp.app.a.customviews.layout.draggablePanel.DraggablePanelActivity
import vn.loitp.app.a.customviews.layout.draggablePanelFree.DraggablePanelFreeActivity
import vn.loitp.app.a.customviews.layout.draggableView.DraggableViewActivity
import vn.loitp.app.a.customviews.layout.expansionPanel.MenuExpansionLayoutActivity
import vn.loitp.app.a.customviews.layout.floatDragLayout.FloatDragLayoutActivity
import vn.loitp.app.a.customviews.layout.flowLayout.FlowLayoutActivity
import vn.loitp.app.a.customviews.layout.greedoLayout.GreedoLayoutActivity
import vn.loitp.app.a.customviews.layout.heartLayout.HeartLayoutActivity
import vn.loitp.app.a.customviews.layout.reflection.ReflectionLayoutActivity
import vn.loitp.app.a.customviews.layout.relativePopupWindow.RelativePopupWindowActivity
import vn.loitp.app.a.customviews.layout.rippleLayout.RippleLayoutActivity
import vn.loitp.app.a.customviews.layout.rotateLayout.RotateLayoutActivity
import vn.loitp.app.a.customviews.layout.roundableLayout.RoundableLayoutActivity
import vn.loitp.app.a.customviews.layout.scrollView2d.ScrollView2DActivity
import vn.loitp.app.a.customviews.layout.scrollView2d.ScrollView2DAdvanceActivity
import vn.loitp.app.a.customviews.layout.sequenceLayout.SequenceLayoutActivity
import vn.loitp.app.a.customviews.layout.shadowLayout.ShadowLayoutActivity
import vn.loitp.app.a.customviews.layout.shapeOfView.ShapeOfViewActivity
import vn.loitp.app.a.customviews.layout.splitPanelLayout.SplitPanelLayoutActivity
import vn.loitp.app.a.customviews.layout.squareLayout.SquareLayoutActivity
import vn.loitp.app.a.customviews.layout.swipeBackLayout.SwipeBackLayoutActivity
import vn.loitp.app.a.customviews.layout.swipeRefreshLayout.MenuSwipeRefreshLayoutActivity
import vn.loitp.app.a.customviews.layout.swipeRevealLayout.SwipeRevealLayoutActivity
import vn.loitp.app.a.customviews.layout.transformationLayout.TransformationActivity
import vn.loitp.app.a.customviews.layout.transformationLayout.single.TransformationSingleActivity
import vn.loitp.app.a.customviews.layout.zoomLayout.ZoomLayoutActivity
