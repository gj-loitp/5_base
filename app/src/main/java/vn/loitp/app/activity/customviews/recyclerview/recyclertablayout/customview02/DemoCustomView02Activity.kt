...
class DemoCustomView02Activity : BaseFontActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerTabLayout.setUpWithAdapter(DemoCustomView02Adapter(viewPager))
    ...
    companion object {
        ...
        fun startActivity(context: Context, demo: Demo) {
            val intent = Intent(context, DemoCustomView02Activity::class.java)
