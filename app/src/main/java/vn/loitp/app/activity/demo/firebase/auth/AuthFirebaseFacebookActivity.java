...
public class AuthFirebaseFacebookActivity extends BaseFontActivity implements View.OnClickListener {
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            try {
                LImageUtil.Companion.load(this, user.getPhotoUrl() + "?height=500", findViewById(R.id.icon), R.color.colorPrimary, R.color.colorPrimary, new RequestListener<Drawable>() {
                    @Override
