...
public class MenuAdsActivity extends BaseFontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_1).setOnClickListener(v -> {
            final Intent intent = new Intent(activity, AdmobBannerActivity.class);
            startActivity(intent);
            LActivityUtil.tranIn(activity);
        });
        findViewById(R.id.bt_2).setOnClickListener(v -> {
            final Intent intent = new Intent(activity, AdmobInterstitialActivity.class);
            startActivity(intent);
            LActivityUtil.tranIn(activity);
        });
        findViewById(R.id.bt_3).setOnClickListener(v -> {
            final Intent intent = new Intent(activity, AdmobRewardedVideoActivity.class);
