...
public class FrmVideo extends BaseFragment implements PreviewView.OnPreviewChangeListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void findViews(View view) {
        progressBar = (ProgressBar) view.findViewById(loitp.core.R.id.progress_bar);
        LUIUtil.setColorProgressBar(progressBar, ContextCompat.getColor(progressBar.getContext(), loitp.core.R.color.White));
        playerView = view.findViewById(loitp.core.R.id.player_view);
        previewTimeBar = playerView.findViewById(loitp.core.R.id.exo_progress);
        previewTimeBarLayout = playerView.findViewById(loitp.core.R.id.previewSeekBarLayout);
        previewTimeBarLayout.setTintColorResource(loitp.core.R.color.colorPrimary);
        previewTimeBar.addOnPreviewChangeListener(this);
        ivThumbnail = (ImageView) playerView.findViewById(loitp.core.R.id.image_view_thumnail);
        exoFullscreenIcon = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_fullscreen_toggle_icon);
        tvTitle = (TextView) playerView.findViewById(loitp.core.R.id.tv_title);
        exoBackScreen = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_back_screen);
        exoVolume = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_volume);
        exoSetting = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_setting);
        exoCc = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_cc);
        exoPlaylist = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_playlist);
        exoHearing = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_hearing);
        exoPictureInPicture = (ImageButton) playerView.findViewById(loitp.core.R.id.exo_picture_in_picture);

        seekbarVolume = (VerticalSeekBar) playerView.findViewById(loitp.core.R.id.seekbar_volume);
        seekbarBirghtness = (VerticalSeekBar) playerView.findViewById(loitp.core.R.id.seekbar_birghtness);
        LUIUtil.setColorSeekBar(seekbarVolume, ContextCompat.getColor(getActivity(), loitp.core.R.color.White));
        LUIUtil.setColorSeekBar(seekbarBirghtness, ContextCompat.getColor(getActivity(), loitp.core.R.color.White));
        ivVolumeSeekbar = (ImageView) playerView.findViewById(loitp.core.R.id.exo_volume_seekbar);
        ivBirghtnessSeekbar = (ImageView) playerView.findViewById(loitp.core.R.id.exo_birghtness_seekbar);

        debugRootView = view.findViewById(loitp.core.R.id.controls_root);
            ...
            if (trackGroups.length != 0) {
                ...
                switch (uizaPlayerManager.getPlayer().getRendererType(i)) {
                    case C.TRACK_TYPE_AUDIO:
                        label = loitp.core.R.string.audio;
                        break;
                    case C.TRACK_TYPE_VIDEO:
                        label = loitp.core.R.string.video;
                        break;
                    case C.TRACK_TYPE_TEXT:
                        label = loitp.core.R.string.text;
                        break;
                    default:
                        continue;
                }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (seekBar == seekbarVolume) {
            ...
            if (progress >= 66) {
                ivVolumeSeekbar.setImageResource(loitp.core.R.drawable.ic_volume_up_black_48dp);
            } else if (progress >= 33) {
                ivVolumeSeekbar.setImageResource(loitp.core.R.drawable.ic_volume_down_black_48dp);
            } else {
                ivVolumeSeekbar.setImageResource(loitp.core.R.drawable.ic_volume_mute_black_48dp);
            }
            ...
            if (progress >= 85) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_7_black_48dp);
            } else if (progress >= 71) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_6_black_48dp);
            } else if (progress >= 57) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_5_black_48dp);
            } else if (progress >= 42) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_4_black_48dp);
            } else if (progress >= 28) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_3_black_48dp);
            } else if (progress >= 14) {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_2_black_48dp);
            } else {
                ivBirghtnessSeekbar.setImageResource(loitp.core.R.drawable.ic_brightness_1_black_48dp);
            }
