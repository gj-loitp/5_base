...
public class ExpansionPanelSampleActivityProgrammatically extends AppCompatActivity {
    ...
    private ExpansionLayout createExpansionLayout() {
        ...
        expansionLayout.addView(layout, ViewGroup.LayoutParams.MATCH_PARENT, Utils.dpToPx(this, 48)); //equivalent to addView(linearLayout)
        ...
        layout.addView(text, ViewGroup.LayoutParams.MATCH_PARENT, Utils.dpToPx(this, 200));
    ...
    private ExpansionHeader createExpansionHeader() {
        ...
        expansionHeader.setPadding(Utils.dpToPx(this, 16), Utils.dpToPx(this, 8), Utils.dpToPx(this, 16), Utils.dpToPx(this, 8));
