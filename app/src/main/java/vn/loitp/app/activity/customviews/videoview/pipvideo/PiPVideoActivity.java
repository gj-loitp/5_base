...
public class PiPVideoActivity extends BaseActivity {
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        ...
                        0);
        final Icon icon = Icon.createWithResource(activity, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(activity, R.drawable.ic_info_24dp),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);// Prepare string resources for Picture-in-Picture actions.
    ...
    protected int setLayoutResourceId() {
        return R.layout.activity_pip_video;
    }
