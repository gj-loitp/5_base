...
import com.views.imageview.strectchyimageview.LStretchyImageView;
...
public class StrectchyImageViewActivity extends BaseFontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LImageUtil.INSTANCE.load(getActivity(), Constants.INSTANCE.getURL_IMG_LONG(), lStretchyImageView);
    }
