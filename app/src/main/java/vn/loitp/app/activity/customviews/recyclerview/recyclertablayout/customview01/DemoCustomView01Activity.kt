...
class DemoCustomView01Activity : BaseFontActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerTabLayout.setUpWithAdapter(DemoCustomView01Adapter(viewPager))
    }
    ...
    companion object {
        ...
        fun startActivity(context: Context, demo: Demo) {
            val intent = Intent(context, DemoCustomView01Activity::class.java)
