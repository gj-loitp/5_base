...
public class ViewPagerMenuActivity extends BaseFontActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_double_viewpager).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_detect_viewpager_swipe_out:
                ...
                break;
            case R.id.bt_double_viewpager:
                intent = new Intent(activity, DoubleViewPagerSplashActivity.class);
                break;
