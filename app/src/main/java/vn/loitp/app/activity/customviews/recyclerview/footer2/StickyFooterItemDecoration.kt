...
class StickyFooterItemDecoration : ItemDecoration() {
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        parent.adapter?.let { a ->
            ...
            outRect.top = calculateTopOffset(parent = parent, footerView = view, itemCount = adapterItemCount)
        }
    }

    private fun calculateTopOffset(parent: RecyclerView, footerView: View, itemCount: Int): Int {
        val topOffset = (parent.height
                - parent.paddingTop
                - parent.paddingBottom
                - visibleChildHeightWithFooter(parent = parent, footerView = footerView, itemCount = itemCount))
    ...
    private fun visibleChildHeightWithFooter(parent: RecyclerView, footerView: View, itemCount: Int): Int {
        ...
        for (i in 0 until onScreenItemCount - 1) {
            ...
            val height = (parent.getChildAt(i).height + layoutParams.topMargin + layoutParams.bottomMargin)
            totalHeight += height
        }
