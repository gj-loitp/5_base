...
class Item internal constructor(val name: String,
    ...
    companion object {
        ...
        private const val LARGE_BASE_URL = "http://storage.googleapis.com/androiddevelopers/sample_data/activity_transition/large/"
        private const val THUMB_BASE_URL = "http://storage.googleapis.com/androiddevelopers/sample_data/activity_transition/thumbs/"
