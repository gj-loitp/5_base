package vn.loitp.a.anim.animationView
...
class AnimationViewActivityFont : BaseActivityFont() {
    ...
    private fun setupViews() {
        lActionBar.apply {
            ...
            this.tvTitle?.text = AnimationViewActivityFont::class.java.simpleName
        }
        setupAnimList()
