...
class MenuNotificationActivityFont : BaseActivityFont(), View.OnClickListener {
    ...
    private fun setupViews() {
        lActionBar.apply {
            ...
            this.tvTitle?.text = MenuNotificationActivityFont::class.java.simpleName
        }
    ...
    override fun onClick(v: View) {
        ...
        when (v) {
                    ...
                    NottiFactory[NottiFactory.TYPE.STANDARD, "some text", "some content"]
                        .setContentAction(
                            ContentAction(
                                Intent(
                                    this,
                                    MenuNotificationActivityFont::class.java
                                ),
                                this
                            )
                        )
            ...
            btSimpleNotificationActions -> {
                intent = Intent(this, MenuNotificationActivityFont::class.java)
            ...
            btNotificationHeadsup -> {
                ...
                val notificationIntent = Intent(this, MenuNotificationActivityFont::class.java)
