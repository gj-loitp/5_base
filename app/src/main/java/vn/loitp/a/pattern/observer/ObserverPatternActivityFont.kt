...
@IsFullScreen(false)
class ObserverPatternActivityFont : BaseActivityFont(), View.OnClickListener, RepositoryObserver {
    ...
    private fun setupViews() {
        lActionBar.apply {
            ...
            this.tvTitle?.text = ObserverPatternActivityFont::class.java.simpleName
        }
