...
public class LIconView extends RelativeLayout implements View.OnClickListener {
    ...
    public LIconView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LIconView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        inflate(getContext(), R.layout.view_l_icon, this);
